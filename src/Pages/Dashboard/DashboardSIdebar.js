...
const DashboardSIdebar = () => {
    ...
    const sideBarItem =
        <React.Fragment>
            ...
            <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                <Link to='/dashboard' className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <MdProductionQuantityLimits></MdProductionQuantityLimits>
    ...
    return (
        <div>
            ...
            className="w-64 z-40 absolute bg-gray-800 shadow h-screen flex-col justify-between md:hidden transition duration-150 ease-in-out">
                <button aria-label="toggle sidebar" 
                className={isOpen ? "hidden" : "h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800"} onClick={() => setIsOpen(true)}>
                ...
                className={isOpen ? "h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" : "hidden"} onClick={() => setIsOpen(false)}>
